...
namespace DataAccess
{
    ...
    public class DataAccessService
    {
        ...
        private void InitTestData()
        {
            ...
            //creo colas
            DTOQueue dtoq1 = new DTOQueue() { Id = "5000", Media = "MoH", MediaType = "default", QueueMembers = new List<DTOQueueMember>(), Weight = 1, WrapupTime = 3, MemberStrategy = "rrmemory", CallOrderStrategy = "default" };
            DTOQueue dtoq2 = new DTOQueue() { Id = "6000", Media = "MoH", MediaType = "default", QueueMembers = new List<DTOQueueMember>(), Weight = 2, WrapupTime = 3, MemberStrategy = "rrmemory", CallOrderStrategy = "default" };
